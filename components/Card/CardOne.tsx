    ...
    return (
      <StyledCard>
        <LeftAlignedCardContent>
          ...
          <CardHeader title={this.props.globalStore!.electionData.electionName} />
          <CardMeta title="시작 날짜" description="2020.02.13~2020.02.15" icon="calendar alternate" />
          <CardMeta title="투표수" description={this.props.globalStore!.electionData.totalVoted.toString()} icon="ticket" />
        </LeftAlignedCardContent>
        <Card.Content extra>
